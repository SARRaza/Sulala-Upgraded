...
class StaffMember {
  ...
  StaffMember({required this.id, required this.image, required this.name,
    required this.role, required this.email, required this.phoneNumber});
  ...
  StaffMember copyWith({
    ...
    return StaffMember(id: id?? this.id, image: image?? this.image,
        name: name?? this.name, role: role?? this.role, email: email?? this
            .email, phoneNumber: phoneNumber?? this.phoneNumber);
  }
}