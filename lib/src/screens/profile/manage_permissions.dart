      ...
      child: ref.watch(staffMemberProvider(widget.staffMemberId)).when(
          ...
          data: (staffMember) {
            if (showList == null) {
              ...
              showList = !isViewOnlySelected;
              isGeneralInfoSelected = staffMember.canEditGeneralInfo ?? false;
              isBreedingInfoSelected = staffMember.canEditBreedingInfo ?? false;
            }
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (showList!) ...[
                          SizedBox(
                              height:
                                  32 * SizeConfig.heightMultiplier(context)),
                          Text(
                  ...
                  child: PrimaryButton(
                    onPressed: () {
                      ref
                          ...
                          .updateMember(staffMember.copyWith(
                              role: isViewOnlySelected
                                  ? 'Viewer'
                                  : isCanEditSelected
                                      ? 'Helper'
                                      : 'Worker',
                              canEditGeneralInfo: isGeneralInfoSelected,
                              canEditBreedingInfo: isBreedingInfoSelected,
                              canEditMedicalInfo: isMedicalInfoSelected));
